...
```javascript
rotl32 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint32-base-rotl@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/number-uint32-base-rotl@umd/bundle.js"></script>
```
...
<html lang="en">
<body>
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/number-uint32-base-to-binary-string@umd/bundle.js"></script>
